							...
							<div class="Reveal-gravity-list mt-0">
									...
									<table class="table table-bordered table-responsive" id="DataTable">
										...
										{ ?>
											...
											<td>
												<a href="#"><img src="../upload/profile/<?php echo $listing['user_photo']; ?>" alt="<?php echo $listing['name']; ?>" heigt="20" title="<?php echo $listing['name']; ?>"></a>
											...
											<td>
												<i class='fa fa-envelope'></i> <?php echo $listing['email']; ?>
												<br>
												<i class='fa fa-mobile'></i> <?php echo $listing['phone']; ?>
