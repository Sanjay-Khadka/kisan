                            ...
                            { ?>
                                ...
                                <div class="form-submit">   
                                    ...
                                    <div class="submit-section">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 col-lg-6">
                                                ...
                                                <select name="user_role" id="user_role" class="form-control combobox" required autocomplete="off">
                                                    ...
                                                    <option value="Seller" <?php if($user['user_role'] == "Seller") echo 'selected = "selected"'; ?> > Seller</option>
                                                    <option value="Buyer / General" <?php if($user['user_role'] == "Buyer / General") echo 'selected = "selected"'; ?>>Buyer / General</option>
                                                </select>
                                            </div>


                                            <div class="form-group col-md-6 col-lg-6">
                                                <label>Is User's KYC Verified?</label>
                                                <select name="isKYCVerified" id="isKYCVerified" class="form-control combobox" required autocomplete="off">
                                                    <!-- <option value="Super Admin" selected="selected">Super Admin</option> -->
                                                    <option value="1" <?php if($user['isKYCVerified'] == "1") echo 'selected = "selected"'; ?> > KYC Verified</option>
                                                    <option value="0" <?php if($user['isKYCVerified'] == "0") echo 'selected = "selected"'; ?> >KYC Not Verified</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group col-md-4">
                                             <?php $default_document = ($user['document'] != '') ? '../upload/profile/kyc/'. $user['document'] : '../upload/profile/kyc/sample-citizenship.jpg'; ?>

                                            <img src="<?php echo $default_document; ?>" />
                                            <a target="_blank" class="btn btn-sm btn-primary" href="<?php echo $default_document; ?>">View Document</a>
                                        </div>
