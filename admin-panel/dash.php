  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Welcome Admin!</p>
      </div>
    ...
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
          ...
          <!-- FIND Your admin Client and add photo -->


          <li><a href="#"><img src="../image/bim.jpg" width="100%" height="100%" alt="not found" /></a></li>
